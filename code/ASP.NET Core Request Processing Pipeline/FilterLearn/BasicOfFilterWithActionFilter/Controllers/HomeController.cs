using BasicOfFilterWithActionFilter.Filters;
using BasicOfFilterWithActionFilter.Models;
using Microsoft.AspNetCore.Mvc;
using System.Diagnostics;

namespace BasicOfFilterWithActionFilter.Controllers
{
    public class HomeController : Controller
    {
        ...
        [ExampleActionFilter]
        [OrderAsyncActionFilter("Dhruvil A. Dobariya", -1)]
