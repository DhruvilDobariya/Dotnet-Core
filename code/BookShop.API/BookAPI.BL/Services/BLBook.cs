...
{
    /// <summary>
    /// It contains business logic and data access logic for book crud operation 
    /// </summary>
    public class BLBook : BLGeneric<BOSD03>, IBLBook
    {
        ...
        #region Constructor
        public BLBook(IConfiguration configuration) : base(configuration.GetConnectionString("DefaultConnection"), "BOSD03", "D03F01", "D03F07")
        {
